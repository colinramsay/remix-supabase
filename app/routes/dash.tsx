import { Form, Link, LoaderFunction, redirect } from 'remix'
...
const Logout = ({ className }: { className: string }) => (
    <Form method="delete" action="/logout">
        <LinkButton type="submit" className={className}>
            Sign out!
        </LinkButton>
    </Form>
)
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                                                            <Menu.Item>
                                                                <Logout className="block py-2 px-4 text-sm text-gray-700" />
                                                            </Menu.Item>
                                                        </Menu.Items>
                                                    </Transition>
                                                </Menu>
                                ...
                                <Disclosure.Panel className="lg:hidden">
                                    ...
                                    <div className="pt-4 pb-3 border-t border-green-700">
                                        <div className="px-5 flex items-center">
                                            ...
                                            <button
                                                type="button"
                                                className="ml-auto bg-green-600 flex-shrink-0 rounded-full p-1 text-green-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-600 focus:ring-white"
                                            >
                                                <span className="sr-only">
                                                    View notifications
                                                </span>
                                        ...
                                        <div className="mt-3 px-2 space-y-1">
                                            <Disclosure.Button
                                                as={Logout}
                                                className="block rounded-md py-2 px-3 text-base font-medium text-white hover:bg-green-500 hover:bg-opacity-75"
                                            >
                                                Sign out
                                            </Disclosure.Button>
                                        </div>
